    ...
    def gemini_chat():
        ...
        while True:
            ...
            if query[0] == 'access' and query [1] == 'data':
                ...
                \n {data_store}\n
                ### "*SYSTEM MESSAGE*" ### Gemini, please read and deeply unterstand all the nuances of the data and metadata in 
            ...
            if query[0] == 'pair' and query [1] == 'programmer':
                ...
                while True:
                    ...
                    \n {diagnostic_summary}\n
                    ### SYSTEM MESSAGE ### Gemini, please read and deeply unterstand all the nuances of 
